...
def callback(msg):
    ...
    ip='192.168.6.162'#rospy.get_param("/vrep_ip") # Gets ip from the param server
    ...
    if clientID!=-1:
	   ...
	   print(msg.steps[0]*ONE_REV/STEPS_TO_REV)
           vrep.simxSetJointTargetPosition(clientID, shoulder_1, msg.steps[1]*ONE_REV/STEPS_TO_REV, opm)
...
def listener():
    ...
    rospy.Subscriber("motion_control/motor_command", MotorCommand, callback)
