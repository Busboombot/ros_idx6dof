...
if("TRUE" STREQUAL "TRUE")
  set(moveit_resources_SOURCE_PREFIX /home/ubuntu/ros_idx6dof/src/moveit_resources)
  set(moveit_resources_DEVEL_PREFIX /home/ubuntu/ros_idx6dof/devel)
  ...
  set(moveit_resources_INSTALL_PREFIX /home/ubuntu/ros_idx6dof/install)
...
if(NOT "/home/ubuntu/ros_idx6dof/src/moveit_resources/include " STREQUAL " ")
  set(moveit_resources_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/ros_idx6dof/src/moveit_resources/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_resources' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/ros_idx6dof/src/moveit_resources/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
    endif()
