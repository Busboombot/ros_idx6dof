...
if("TRUE" STREQUAL "TRUE")
  set(arm_SOURCE_PREFIX /home/drew/ros_idx6dof/src/arm)
  set(arm_DEVEL_PREFIX /home/drew/ros_idx6dof/devel)
  set(arm_INSTALL_PREFIX "")
  set(arm_PREFIX ${arm_DEVEL_PREFIX})
else()
  set(arm_SOURCE_PREFIX "")
  set(arm_DEVEL_PREFIX "")
  set(arm_INSTALL_PREFIX /home/drew/ros_idx6dof/install)
...
if(NOT "/home/drew/ros_idx6dof/devel/include " STREQUAL " ")
  set(arm_INCLUDE_DIRS "")
  set(_include_dirs "/home/drew/ros_idx6dof/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drew/ros_idx6dof/src/arm/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
