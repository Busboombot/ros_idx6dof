...
if("TRUE" STREQUAL "TRUE")
  set(arm_SOURCE_PREFIX /home/eric/ros_idx6dof/src/arm)
  set(arm_DEVEL_PREFIX /home/eric/ros_idx6dof/devel)
  set(arm_INSTALL_PREFIX "")
  set(arm_PREFIX ${arm_DEVEL_PREFIX})
else()
  set(arm_SOURCE_PREFIX "")
  set(arm_DEVEL_PREFIX "")
  set(arm_INSTALL_PREFIX /home/eric/ros_idx6dof/install)
...
if(NOT "/home/eric/ros_idx6dof/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eric/ros_idx6dof/src/arm/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
