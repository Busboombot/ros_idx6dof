...
if("TRUE" STREQUAL "TRUE")
  set(arm_SOURCE_PREFIX /home/ubuntu/ros_idx6dof/src/arm)
  set(arm_DEVEL_PREFIX /home/ubuntu/ros_idx6dof/devel)
  set(arm_INSTALL_PREFIX "")
  set(arm_PREFIX ${arm_DEVEL_PREFIX})
else()
  set(arm_SOURCE_PREFIX "")
  set(arm_DEVEL_PREFIX "")
  set(arm_INSTALL_PREFIX /home/ubuntu/ros_idx6dof/install)
...
if(NOT "/home/ubuntu/ros_idx6dof/devel/include " STREQUAL " ")
  set(arm_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/ros_idx6dof/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/ros_idx6dof/src/arm/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/ros_idx6dof/devel/lib;/home/ubuntu/arm_ws/devel/lib;/opt/ros/kinetic/lib)
