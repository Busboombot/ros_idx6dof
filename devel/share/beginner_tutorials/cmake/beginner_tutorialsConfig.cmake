...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/pi/catkin_idx6dof/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/pi/catkin_idx6dof/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/pi/catkin_idx6dof/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_idx6dof/src/beginner_tutorials/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_idx6dof/devel/lib;/opt/ros/kinetic/lib)
