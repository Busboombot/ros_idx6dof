...
class SwitchRequestRequest {
  ...
  static serialize(obj, bufferInfo) {
    // Serializes a message object of type SwitchRequestRequest
  ...
  static deserialize(buffer) {
    //deserializes a message object of type SwitchRequestRequest
    let tmp;
    let len;
    let data = new SwitchRequestRequest();
...
class SwitchRequestResponse {
  ...
  static serialize(obj, bufferInfo) {
    // Serializes a message object of type SwitchRequestResponse
  ...
  static deserialize(buffer) {
    //deserializes a message object of type SwitchRequestResponse
    let tmp;
    let len;
    let data = new SwitchRequestResponse();
  ...
  static datatype() {
    // Returns string type for a service object
    return 'idxpendant/SwitchRequestResponse';
  }
...
module.exports = {
  Request: SwitchRequestRequest,
  Response: SwitchRequestResponse
};
