...
if("TRUE" STREQUAL "TRUE")
  set(ikfastplug_SOURCE_PREFIX /home/ubuntu/ros_idx6dof/src/ikfastplug)
  set(ikfastplug_DEVEL_PREFIX /home/ubuntu/ros_idx6dof/devel)
  ...
  set(ikfastplug_INSTALL_PREFIX /home/ubuntu/ros_idx6dof/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ikfastplug' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/ros_idx6dof/src/ikfastplug/${idir}'.  Ask the maintainer 'ubuntu <ubuntu@todo.todo>' to fix it.")
    endif()
